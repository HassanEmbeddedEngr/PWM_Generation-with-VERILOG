...
HD_PWD='C:/Users/Hp/PWM_GENERATION/PWM_GENERATION.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_TOP.tcl
